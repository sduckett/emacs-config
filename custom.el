(custom-set-variables
 ...
 '(package-selected-packages
   '(window-numbering-mode window-numbering dap-mode lsp-java lsp-ui company-lsp lsp-mode haskell-interactive-mode yaml-mode wc-mode use-package twittering-mode ssh-config-mode smex ruby-test-mode request-deferred rbenv paren-face ob-http markdown-mode+ magit-gh-pulls inf-ruby ido-vertical-mode ido-ubiquitous idle-highlight-mode htmlize hindent highlight-symbol highlight-quoted highlight-numbers helm-swoop helm-projectile helm-ls-git helm-gtags helm-flyspell helm-flycheck helm-flx helm-descbinds helm-ag haskell-mode haskell-emacs gtags gnuplot-mode gnuplot git-timemachine git-gutter git-annex gist fuzzy flycheck-tip expand-region epresent elisp-slime-nav csv-mode company clojure-mode-extra-font-locking clj-refactor bbdb alert ace-jump-mode))
