...
*** General prog-mode hooks
    ...
    created for prog-mode should apply to all language modes.)

    Subword mode lets me move between SegmentsOfACamelCasedThing and
    idle-highlight-mode will hightlight the word under the point.
...
#+END_SRC
    ...
    I think it's nice for things like FIXME and TODO to be highlighted so they
    stand out.
